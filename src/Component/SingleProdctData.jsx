          ...
          productAllData.map((cvl) => {
            return <>
              ...
              <div className='prdctDtl'>
                <h3>Brand:   {cvl.brand}</h3>

                <h3>Product: {cvl.title}</h3>

                <h4>Overview: {cvl.description}</h4>
                <h3>Category: {cvl.category}</h3>
                <h3>Rating: {cvl.rating}</h3>
                <h3>Stock: {cvl.stock}</h3>

                <h3>Price: {cvl.price}</h3>
              </div>
              {/* <div className=''> */}
